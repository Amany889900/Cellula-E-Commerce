...
function Wishlist() {
const {wishProducts,removeFromWishlist} = useContext(WishListContext);
  return (
     <>
    <div className="w-[80%] mx-auto px-10 py-10 mt-20 mb-40 relative border-b-1">
    <span className="text-[#DB4444] text-[16px] font-bold  leading-[20px] mt-10 mb-4 before:inline-block before:rounded-[4px] before:w-[20px] before:h-[40px] before:bg-[#DB4444] before:content-[''] before:mr-4 inline-flex items-center">Wish List</span>
    <h2 className="font-semibold text-[24px] sm:text-[36px] leading-[48px] tracking-[4%] mb-14">Wish List</h2>
   <div className="mb-20">
   
     <div className="flex flex-wrap">
     {wishProducts?.map((product,idx)=>(
    ...
    <div className="absolute right-0 mr-2 top-[12px]">
      ...
      className="cursor-pointer w-[36px] h-[36px] rounded-full flex justify-center items-center mb-4 bg-white hover:bg-black hover:text-white"><i class="fa-solid fa-trash-can"></i></button>
    </div>
  </div>
